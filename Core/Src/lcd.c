...
//-------------------------------------------------------------------------------------------------------------------
// 函数简介     设置显示方向
// 参数说明     dir             显示方向  参照  lcd_dir_enum 枚举体定义
// 返回参数     void
...
//-------------------------------------------------------------------------------------------------------------------
// 函数简介     设置显示颜色
// 参数说明     pen             颜色格式 RGB565  rgb565_color_enum 枚举值或者自行写入
// 参数说明     bgcolor         颜色格式 RGB565  rgb565_color_enum 枚举值或者自行写入
// 返回参数     void
...
//-------------------------------------------------------------------------------------------------------------------
// 函数简介     设置显示字体
// 参数说明     dir             显示方向  参照  lcd_font_size_enum 枚举体定义
// 返回参数     void
...
//-------------------------------------------------------------------------------------------------------------------
// 函数简介     LCD 屏幕填充函数
// 参数说明     color           颜色格式 RGB565  rgb565_color_enum 枚举值或者自行写入
// 返回参数     void
...
// 参数说明     color           颜色格式 RGB565 可以使用 rgb565_color_enum
// 返回参数     void
// 使用示例     lcd_region_fill(0, 0, 10, 10, RGB565_RED);
// 备注信息
//-------------------------------------------------------------------------------------------------------------------
void lcd_region_fill(uint16 xsta, uint16 ysta, uint16 xend, uint16 yend, const uint16 color)
{
    ...
    height = yend - ysta + 1;           /* 高度 */
		...
		lcd_set_region(xsta, ysta, xend, yend); //设置光标位置
...
// 参数说明     color           颜色格式 RGB565  rgb565_color_enum 枚举值或者自行写入
// 返回参数     void
// 使用示例     lcd_draw_big_point(0, 0, RGB565_RED);            //坐标0,0画一个红色大的点
// 备注信息
//-------------------------------------------------------------------------------------------------------------------
...
// 参数说明     color           颜色格式 RGB565  rgb565_color_enum 枚举值或者自行写入
// 返回参数     void
// 使用示例     lcd_draw_rectangle(0, 0, 100, 100,RGB565_RED);            //坐标0,0画一个红色大的点
// 备注信息
//-------------------------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------------------------
// 函数简介     LCD画圆
// 参数说明     x               圆心x坐标 [0, lcd_width_max-1]
// 参数说明     y               圆心y坐标 [0, lcd_height_max-1]
// 参数说明     r               圆的半径  [0, lcd_width_max-1]
// 参数说明     color           颜色格式 RGB565  rgb565_color_enum 枚举值或者自行写入
// 返回参数     void
// 使用示例     draw_circle(100, 100, 30, RGB565_RED);
// 备注信息
//-------------------------------------------------------------------------------------------------------------------
