...
#define LCD_RST_PORT       GPIOA  // Reset引脚所在的端口
#define LCD_RST_PIN        GPIO_PIN_0  // Reset引脚的引脚号

#define LCD_DC_PORT        GPIOA  // DC引脚所在的端口
#define LCD_DC_PIN         GPIO_PIN_1  // DC引脚的引脚号

#define LCD_CS_PORT        GPIOA  // CS引脚所在的端口
#define LCD_CS_PIN         GPIO_PIN_2  // CS引脚的引脚号

#define LCD_BL_PORT        GPIOA  // BL引脚所在的端口
#define LCD_BL_PIN         GPIO_PIN_3  // BL引脚的引脚号

#define LCD_SCLK_PORT      GPIOA  // SCLK引脚所在的端口
#define LCD_SCLK_PIN       GPIO_PIN_5  // SCLK引脚的引脚号

#define LCD_MOSI_PORT      GPIOA  // MOSI引脚所在的端口
#define LCD_MOSI_PIN       GPIO_PIN_7  // MOSI引脚的引脚号
